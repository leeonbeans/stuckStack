...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        actInfo = new QAction(QWMainWind);
        actInfo->setObjectName("actInfo");
        QIcon icon11(QIcon::fromTheme(QIcon::ThemeIcon::HelpFaq));
        actInfo->setIcon(icon11);
        ...
        menuBar->setGeometry(QRect(0, 0, 543, 24));
        ...
        actAskHelp = new QMenu(menuBar);
        actAskHelp->setObjectName("actAskHelp");
        ...
        menuBar->addAction(actAskHelp->menuAction());
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actInfo->setText(QCoreApplication::translate("QWMainWind", "\345\205\263\344\272\216", nullptr));
        ...
        actAskHelp->setTitle(QCoreApplication::translate("QWMainWind", "\345\270\256\345\212\251", nullptr));
    } // retranslateUi
